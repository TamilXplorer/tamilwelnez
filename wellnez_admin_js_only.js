    ...
    const renderDashboard = () => {
            ...
            <div class="admin-layout" style="max-width: 100% !important; padding-left: 4vw !important; padding-right: 4vw !important;">
                <div class="admin-header-row">
                    ...
                    <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
                        ...
                        <button class="btn btn-outline admin-nav-tab ${activeTab === 'payments' ? 'btn-secondary' : ''}" data-tab="payments"><i class="fa-solid fa-credit-card"></i> Payments</button>
                        <button class="btn btn-outline" id="admin-logout-btn" style="color:#e74c3c; border-color:#e74c3c; margin-left: 10px;"><i class="fa-solid fa-right-from-bracket"></i> Logout</button>
                    </div>
                </div>
                ...
                <div class="modal-content-card" style="max-width: 650px;">
                    ...
                    <form id="admin-product-form" style="max-height: 500px; overflow-y: auto; padding-right:10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div id="prod-img-upload-zone" style="border:2px dashed var(--border-color); border-radius:6px; padding:20px; text-align:center; cursor:pointer; background:var(--bg-primary); transition:border-color 0.2s;" onclick="document.getElementById('prod-img-file').click()">
                            ...
                            <input type="hidden" id="prod-image" required>
                            <div style="margin-top:10px; display:flex; align-items:center; gap:8px;">
                                <div style="flex:1; height:1px; background:var(--border-color);"></div>
                                <span style="font-size:0.75rem; color:var(--text-muted); white-space:nowrap;">or enter URL / path</span>
                                <div style="flex:1; height:1px; background:var(--border-color);"></div>
                            </div>
                            <input type="text" id="prod-image-url" class="form-control" placeholder="images/custom.png" style="margin-top:10px;">
                        </div>
                        <div class="form-group">
        ...
        if (productModal && productForm) {
            ...
            if (prodImgFile) {
                ...
                prodImgZone.addEventListener("dragover", (e) => { e.preventDefault(); prodImgZone.style.borderColor = "var(--text-main)"; });
                prodImgZone.addEventListener("dragleave", () => { prodImgZone.style.borderColor = "var(--border-color)"; });
