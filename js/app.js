    ...
    const AboutView = () => `
        <div class="about-grid-container">
            ...
            <div class="about-image-panel">
                <img src="https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&q=80&w=800" alt="our story skincare concept" style="width:100%; border-radius:12px; box-shadow:var(--shadow-md); object-fit:cover; display:block;">
            </div>
        </div>
    `;
